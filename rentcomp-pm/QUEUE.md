...
| 1a | F0-S1a backend scaffold (uv, FastAPI, entry point) | INFRA | T-S3 | **IN_REVIEW** | dev @ story/F0-S1a 7a41071; app object = rentcomp.app:app; 71/71 green claimed; QA verifying |
| 1b | F0-S1b frontend scaffold (Vite, Tailwind, codegen) | UI | F0-S1a | BLOCKED | needs FastAPI schema for codegen |
| 2 | F0-S3 weighted stats | PIPE | T-S3 | **DISPATCHED** | QA tests red on story/F0-S3-qa @ 92da7a0; dev phase waits for F0-S1a merge (serialization ruling + needs installed scaffold) |
