...
| 5 | F0-S2 derivation graph | PIPE | F0-S3, F0-S5 | **DISPATCHED** | ✅ ADR-001 SIGNED OFF by owner 2026-07-26. `as_of` = pull date; guard trips if it trips at ANY drift edge. QA writing tests; checkpoint 1 cleared |
