...
| 5 | F0-S2 derivation graph | PIPE | F0-S3, F0-S5 | **HELD — AWAITING OWNER SIGN-OFF** | ADR-001 committed 4a0aac4. **No QA, no implementation until owner approves** (charter checkpoint 1). 2 semantic questions open: `as_of` = pull date vs wall clock; guard-vs-curve when the drift band straddles the guard |
